...
const DisplayTodayUSUnits = ({ weatherData }) => {
            ...
            <CardContent>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6} md={4}>
                        {renderWeatherDetail('Temperature', currentConditions.temp, '°F')}
                    </Grid>
                    <Grid item xs={12} sm={6} md={4}>
                        {renderWeatherDetail('Feels Like', currentConditions.feelslike, '°F')}
                    </Grid>
                    <Grid item xs={12} sm={6} md={4}>
                            ...
                            <Grid item key={index} xs={12} sm={3} md={2} sx={{ minWidth: '200px' }}>
                                <Card variant="outlined">
                                    <CardContent>
                                        ...
                                        {renderWeatherDetail('Temperature', hour.temp, '°F')}
                                        {renderWeatherDetail('Feels Like', hour.feelslike, '°F')}
...
export default DisplayTodayUSUnits;
